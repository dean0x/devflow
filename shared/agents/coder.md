...
model: inherit
skills: core-patterns, git-safety, implementation-patterns, commit, typescript, react, test-design, codebase-navigation, code-smell, input-validation, accessibility, frontend-design
---
