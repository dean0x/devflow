...
- **PR_DESCRIPTION** (optional): PR body text from GitHub. Author's stated intent — use to contextualize findings (distinguish intentional choices from oversights). Do NOT review the description itself. `(none)` when absent.
