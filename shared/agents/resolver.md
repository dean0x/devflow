...
- **FEATURE_KNOWLEDGE** (optional): Pre-computed feature area context for convention-aware fixes. Feature patterns help determine if a fix follows area conventions. Follow `devflow:apply-feature-kb`.
