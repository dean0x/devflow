...
└── features/                     # Per-feature knowledge bases (committed to git)
    ├── {slug}/KNOWLEDGE.md
    ├── index.json
    ├── .disabled                 # Sentinel — gates Phase 9 generation and refresh hook
