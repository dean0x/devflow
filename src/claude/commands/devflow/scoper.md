---
description: Specify a single feature through interactive clarification - creates a well-defined GitHub issue ready for Swarm
---

# Scoper - Feature Specification Unit

Transform a rough feature idea into a well-defined, implementation-ready GitHub issue through interactive clarification.
...
```
/scoper User authentication with social login
/scoper Rate limiting for API endpoints
/scoper Dashboard redesign with real-time updates
```
