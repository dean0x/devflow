...
export const DEVFLOW_PLUGINS: PluginDefinition[] = [
  ...
  },
  {
    ...
    skills: ['agent-teams', 'architecture', 'complexity-patterns', 'consistency-patterns', 'database-patterns', 'dependencies-patterns', 'documentation-patterns', 'knowledge-persistence', 'performance', 'regression-patterns', 'review-methodology', 'security', 'testing', 'worktree-support'],
  },
  {
