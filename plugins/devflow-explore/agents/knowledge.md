...
- **DECISIONS_CONTEXT** (optional): Compact ADR/PF index for cross-referencing in the Related section. When `(none)`, skip knowledge cross-references.
...
4. **Cross-reference knowledge**: If DECISIONS_CONTEXT is provided, reference relevant ADR/PF entries in the KB's "Related" section
